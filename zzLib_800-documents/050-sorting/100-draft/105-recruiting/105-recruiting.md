...
if false; then true; # -->
<!-- # --><h3>KVIrc Weak Encryption</h3>
<!--
fi
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">Tested and found KVIrc encryption to use only ECB mode, which outputs 
